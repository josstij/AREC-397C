...
* wtp_2b_584: taste-first
	...
	label var			wtp_2b_584 "WTP for 584 after tasting first"
	summ				wtp_2b_584, detail

* sure_2b_584
	label var			sure_2b_584 "Certainty in WTP for 584 after tasting first"
	label values		sure_2b_584 sure3_lbl
	tab					sure_2b_584, missing

* wtp_2b_793
	capture destring	wtp_2b_793, replace
	label var			wtp_2b_793 "WTP for 793 after tasting first"
	summ				wtp_2b_793, detail

* Sure_2b_793
	label var			sure_2b_793 "Certainty in WTP for 793 after tasting first"
	label values		sure_2b_793 sure3_lbl
	tab					sure_2b_793, missing

* wtp_3b_info_584
	capture destring	wtp_3b_info_584, replace
	label var			wtp_3b_info_584 "WTP for 584 after magnesium information"
	summ				wtp_3b_info_584, detail

* wtp_3b_info_793
	capture destring	wtp_3b_info_793, replace
	label var			wtp_3b_info_793 "WTP for 793 after magnesium information, tasting first"
	summ				wtp_3b_info_793, detail
...
* wtp_2a_info_584
	...
	label var			wtp_2a_info_584 "WTP for 584 after magnesium information first"
	summ				wtp_2a_info_584, detail

* wtp_2a_info_793
	capture destring	wtp_2a_info_793, replace
	label var			wtp_2a_info_793 "WTP for 793 after magnesium information first"
	summ				wtp_2a_info_793, detail

* sure_2a_info_584
	label var			sure_2a_info_584 "Certainty in WTP for 584 after information first"
	label values		sure_2a_info_584 sure3_lbl
	tab					sure_2a_info_584, missing

* sure_2a_info_793
	label var			sure_2a_info_793 "Certainty in WTP for 793 after information first"
...
* wtp_3a_584
	...
	summ				wtp_3a_584, detail

* sure_3a_584
	label var			sure_3a_584 "Certainty in WTP for 584 after information first then tasting"
	label values		sure_3a_584 sure3_lbl
	tab					sure_3a_584, missing

* wtp_3a_793
	capture destring	wtp_3a_793, replace
	label var			wtp_3a_793 "WTP for 793 after information first then tasting"
	summ				wtp_3a_793, detail

* sure_3a_793
	label var			sure_3a_793 "Certainty in WTP for 793 after information first then tasting"
...
* wtp_2b_356
	...
	label var			wtp_2b_356 "WTP for 356 after tasting first"
	summ				wtp_2b_356, detail

* sure_2b_356
	label var			sure_2b_356 "Certainty in WTP for 356 after tasting first"
	label values		sure_2b_356 sure3_lbl
	tab					sure_2b_356, missing

* wtp_2b_831
	capture destring	wtp_2b_831, replace
	label var			wtp_2b_831 "WTP for 831 after tasting first"
	summ				wtp_2b_831, detail

* sure_2b_831
	label var			sure_2b_831 "Certainty in WTP for 831 after tasting first"
	label values		sure_2b_831 sure3_lbl
	tab					sure_2b_831, missing

* wtp_3b_info_356
	capture destring	wtp_3b_info_356, replace
	label var			wtp_3b_info_356 "WTP for 356 after magnesium information, tasting first"
	summ				wtp_3b_info_356, detail

* wtp_3b_info_831
	capture destring	wtp_3b_info_831, replace
	label var			wtp_3b_info_831 "WTP for 831 after magnesium information, tasting first"
	summ				wtp_3b_info_831, detail
...
* wtp_2a_info_356
	...
	label var			wtp_2a_info_356 "WTP for 356 after magnesium information first"
	summ				wtp_2a_info_356, detail

* wtp_2a_info_831
	capture destring	wtp_2a_info_831, replace
	label var			wtp_2a_info_831 "WTP for 831 after magnesium information first"
	summ				wtp_2a_info_831, detail

* sure_2a_info_356
	label var			sure_2a_info_356 "Certainty in WTP for 356 after information first"
	label values		sure_2a_info_356 sure3_lbl
	tab					sure_2a_info_356, missing

* sure_2a_info_831
	label var			sure_2a_info_831 "Certainty in WTP for 831 after information first"
...
**** Consumer prefernce
* This will be part of the overall analysis, not summary statistics
